...
@click.command()
@click.option("--config", "-c", "cfg_path", required=True, type=click.Path(exists=True, dir_okay=False, path_type=Path), help="Path to the YAML configuration file", default=r"C:\Users\cesar\Desktop\Projects\FoundationModels\fimodemix\config\sdes_generation\ode_expressions_1d.yaml")
